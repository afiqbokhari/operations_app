...
class MenuStructureSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 13, 'label' => 'Dashboard',    'route_name' => 'front-desk.dashboard',   'parent_id' => null, 'order' => 1, 'permission' => 'front_desk', 'is_active' => true, 'module' => 'front_desk'],
            ['id' => 12, 'label' => 'Front Desk',   'route_name' => 'front-desk.mail.index', 'parent_id' => null, 'order' => 2, 'permission' => 'front_desk', 'is_active' => true, 'module' => 'front_desk'],
            ...
            ['id' => 8,  'label' => 'Users',        'route_name' => 'users.index',          'parent_id' => null, 'order' => 1, 'permission' => 'users',      'is_active' => true, 'module' => 'admin'],
            ['id' => 9,  'label' => 'Permissions',  'route_name' => 'permissions.index',    'parent_id' => null, 'order' => 2, 'permission' => 'permissions','is_active' => true, 'module' => 'admin'],
            ['id' => 10, 'label' => 'Logs',         'route_name' => 'logs.index',           'parent_id' => null, 'order' => 3, 'permission' => 'logs',       'is_active' => true, 'module' => 'admin'],
            ['id' => 11, 'label' => 'Menus',        'route_name' => 'menus.index',          'parent_id' => null, 'order' => 4, 'permission' => 'menus',      'is_active' => true, 'module' => 'admin'],
        ];
